import {enumLikedIdTypes, IInitLikedId, likedIdTypes} from "../../types/likedIdTypes";
...
export const LikedIdReducer = (state=InitStateLikedId, action:enumLikedIdTypes):IInitLikedId => {
    switch (action.type) {
