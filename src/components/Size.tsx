  ...
  return (
    <ul className="size_list">
      <li
        ...
        className={addClass({ active_size_item: title.size === "" })}
      >
        {t("category_functions.all_size")}
      </li>
      <li
        onClick={() => {
          ClickSize("large");
        }}
        className={addClass({ active_size_item: title.size === "large" })}
      >
      ...
      <li
        ...
        className={addClass({ active_size_item: title.size === "medium" })}
      >
        <i className="rd__svg-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li
        ...
        className={addClass({ active_size_item: title.size === "small" })}
      >
        <i className="rd__svg-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
