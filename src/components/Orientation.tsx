...
const Orientation:React.FC = () => {
    return (
        <ul className='orientation_list'>
            <li>Все варианты ариентации</li>
            <li> <i className='rd__svg-icon'>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="16" viewBox="0 0 24 16">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g transform="translate(-914.000000, -184.000000)" fill="#9E9E9E" fill-rule="nonzero">
                ...
                <span>Горизонтальная</span></li>
            <li>
                <i className='rd__svg-icon'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="24px" viewBox="0 0 16 24">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g transform="translate(-918.000000, -220.000000)" fill="#9E9E9E" fill-rule="nonzero">
            ...
            <li>
                <i className='rd__svg-icon'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 20 20">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g transform="translate(-916.000000, -262.000000)" fill="#9E9E9E" fill-rule="nonzero">
                ...
                <span>Квадратное изображение</span>
            </li>
        </ul>
    );
};
