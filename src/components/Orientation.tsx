...
const Orientation:React.FC = () => {
    ...
    const title = useTypedSelector(state=> {
            return state.category.orientation;
        }
    )
            ...
            <li onClick={()=>{ClickOrientation('square')}} className={addClass({'active_orientation_item':(title === 'square')})}>
                <i className='rd__svg-icon'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 20 20">
                        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                            <g transform="translate(-916.000000, -262.000000)" fill="#9E9E9E" fillRule="nonzero">
